...
namespace Logic.Domain.Kuriimu2.KomponentAdapter
{
    internal class BinaryWriterX : IBinaryWriterX
    {
        ...
        public BitOrder BitOrder
        {
            ...
            set => _writer.BitOrder = (Komponent.Contract.Enums.BitOrder)value;
        }

        public ByteOrder ByteOrder
        {
            get => (ByteOrder)_writer.ByteOrder;
            set => _writer.ByteOrder = (Komponent.Contract.Enums.ByteOrder)value;
        }
        ...
        {
            _writer = new Komponent.IO.BinaryWriterX(input, encoding, leaveOpen, (Komponent.Contract.Enums.ByteOrder)byteOrder, (Komponent.Contract.Enums.BitOrder)bitOrder, blockSize);
        }
